...
export function renderModals(container: HTMLElement) {
  container.innerHTML += `
    <div id="walk-away-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center ">
    ...
    <div id="phone-friend-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center "></div>
    <div id="audience-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center "></div>
    <div id="prize-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center "></div>
  `;
